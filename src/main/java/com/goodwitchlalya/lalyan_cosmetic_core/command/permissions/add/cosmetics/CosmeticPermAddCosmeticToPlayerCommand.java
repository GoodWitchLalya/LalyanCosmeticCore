...
public class CosmeticPermAddCosmeticToPlayerCommand extends CommandBase {
     ...
     *
     */
    public CosmeticPermAddCosmeticToPlayerCommand() {
        super("player", "Manages the cosmetics' permissions for players");
        this.cosmeticID = this.withRequiredArg("Cosmetic ID", "The permission name", ArgTypes.STRING);
