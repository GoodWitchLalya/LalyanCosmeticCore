...
import com.goodwitchlalya.lalyan_cosmetic_core.Util.ListUtil;
import com.goodwitchlalya.lalyan_cosmetic_core.Util.ModelUtils;
...
public class CosmeticCore extends JavaPlugin {
    ...
    protected void setup() {
        ...
        getEventRegistry().registerGlobal(PlayerReadyEvent.class, (event) -> {
            ...
            //HytaleServer.get().getCommandManager().handleCommand(ConsoleSender.INSTANCE, "model set " + modelName + " " + event.getPlayer().getDisplayName());
            ...
            attachments.add(new ModelAttachment(
                    "Resources/Cosmetics/Head/Alien_Antenna/Alien_Antenna.blockymodel",
                    "Resources/Cosmetics/Head/Alien_Antenna/Alien_Antenna.png",
                    "",
                    "",
                    1
            ));
